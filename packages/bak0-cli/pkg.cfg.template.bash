...
## The full path to the workspace directory on the Windows WSL system (eg, C:/Users/dev/projects/bak0)
...
# The full path to the workspace directory on macOS (eg, /Users/dev/projects/bak0)
