...
mv "${SNAP_DIR}"/bak0_*_amd64.snap "${SNAP_DIR}/bak0_${CARGO_VERSION}_amd64.snap"
mv "${SNAP_DIR}"/bak0_*_arm64.snap "${SNAP_DIR}/bak0_${CARGO_VERSION}_arm64.snap"
mv "${SNAP_DIR}"/bak0_*_armhf.snap "${SNAP_DIR}/bak0_${CARGO_VERSION}_armhf.snap"
